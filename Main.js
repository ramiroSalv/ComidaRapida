...
const mcdonalsSucursal1 = new Sucursal(1, new Direccion("América", "Argentina", "Córdoba", "Pasaje España", 1235), [producto1Stock, producto2Stock], mcdonalsGerente, 50000, [empleado1], mcdonalsMenu);
